...
namespace sjtu {
    ...
    public:
        ...
        public:
            ...
            iterator(Node *curr, linked_hashmap *source):curr(curr), source(source) {}
            ...
            linked_hashmap::value_type *operator->() noexcept {
                return curr->packet;
            }

            bool operator==(const iterator &rhs) const {
                return curr == rhs.curr && source == rhs.source;
            }
        ...
        public:
            ...
            const_iterator(Node *curr, linked_hashmap *source):curr(curr), source(source) {}
         ...
         */
        iterator begin() {
            return iterator(head->next_list, this);
        }
        ...
        const_iterator cbegin() {
            return const_iterator(head->next_list, this);
        }
